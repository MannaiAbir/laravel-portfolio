<section id="home"
    ...
    <div class="container mx-auto h-full">
        <div class="flex flex-col lg:flex-row items-center h-full pt-8">
            <div class="flex-1 flex flex-col items-center lg:items-start"><br><br>
                <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Abir! 👋</p>
                <h1
                    class="
                        text-4xl
                        leading-[44px]
                ...
                <p
                    ...
                    lg:text-left
                    ">
                    The customer himself should be able to pursue the promotion
                ...
                <div class="pt-12">
                    ...
                    <div class="flex items-center mb-6">
                        <a class="
                                ...
                                text-black
                                dark:text-white
                                hover:bg-light-secondary hover:border-light-secondary dark:hover:bg-dark-secondary dark:hover:border-dark-secondary
                                mr-3 sm:mr-4 "
                            href="https://www.facebook.com/abir.mannai.161/">
                  ...
                  dark:text-white hover:bg-light-secondary hover:border-light-secondarydark:hover:bg-dark-secondary dark:hover:border-dark-secondary mr-3 sm:mr-4 "
                            href="https://www.youtube.com/channel/UCKW-mISfMV8FYKD5abheMNw">
                  ...
                  items-center justify-center
                  border border-white text-black
                  dark:text-white hover:bg-light-secondary hover:border-light-secondary
                  dark:hover:bg-dark-secondary dark:hover:border-dark-secondary mr-3 sm:mr-4 "
                            href="https://www.linkedin.com/in/abir-mannai-164227226/">
